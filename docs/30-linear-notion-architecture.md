...
- **📬 Bandeja de revisión - Rick**: outputs internos de agentes (auditorías, benchmarks, smokes, reportes de revisión), ligados a proyectos. No usar para propuestas comerciales Granola. La DB humana "📦 Entregables" (ID `462adf65`) fue eliminada por David.
