...
> **Nota de vigencia (2026-08-07):** el timeline de PBIR citado abajo es el de la investigación original (2026-03-05). Verificado con el blog oficial de Microsoft Power BI al ejecutar este rescate: el default en Power BI Service (ene-feb 2026) llegó según lo previsto; el default en Desktop tuvo un retraso documentado hasta el release de **mayo 2026** (no marzo, como decía la investigación original). La disponibilidad general (GA) sigue targeteada para Q3 2026 — no se encontró confirmación pública de que ya haya ocurrido al momento de este rescate; **revalidar antes de tratar GA como hecho consumado**. Fuente: [PBIR will become the default Power BI Report Format — Microsoft Power BI Blog](https://powerbi.microsoft.com/en-us/blog/pbir-will-become-the-default-power-bi-report-format-get-ready-for-the-transition/). Rescatado desde `cursor/power-bi-libraries-formats-5c1b` @ `6a64515c` (PKG-UAS-P1-2-FOSSIL3-EXEC, 2026-08-07).
