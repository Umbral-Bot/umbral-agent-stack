# ADR-013 — Codegen backend stage gate (Plan B: Hostinger)

> Renumerado desde ADR-011 al rescatarlo del PR #321 (2026-07-03): main ya tenía dos ADR-011
> (orquestación-editorial-criterios-duros y pit-product-tournament-scope); siguiente slot libre = 013.
