...
> **SUPERSEDED / HISTÓRICO** — diseño no implementado; handlers `code.*` y Worker Linux `:8089` ausentes en `main`. Archivado desde `antigravity/sync-uncommitted-changes` @ `9e32a99b` (PKG-UAS-P1-2-ORPHAN58-CHERRY25-EXEC, 2026-08-07).
