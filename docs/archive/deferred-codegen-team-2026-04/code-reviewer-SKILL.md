...
> **DEFERRED_PRODUCT** — no cablear a Rick/templates hasta GO de producto explícito. Archivado desde `antigravity/sync-uncommitted-changes` @ `9e32a99b` (PKG-UAS-P1-2-ORPHAN58-CHERRY25-EXEC, 2026-08-07).
