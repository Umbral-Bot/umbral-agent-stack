...
> **SUPERSEDED** — V1 descartado; vigente: `.claude/skills/notion-governance-runtime/SKILL.md` + `docs/plans/granola-capitalization-hybrid-plan-2026-07-16.md`. Archivado desde `codex/notion-governance-v1-contract` @ `2221f5af` (PKG-UAS-P1-2-ORPHAN58-CHERRY25-EXEC, 2026-08-07).
