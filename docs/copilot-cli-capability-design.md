...
| **F7.rehearsal-5A** | **⏳ deploy pending** | **code gate open: `_REAL_EXECUTION_IMPLEMENTED=True`. L3 (`RICK_COPILOT_CLI_EXECUTE=false`) remains closed and should still return `execute_flag_off_dry_run`; post-deploy evidence must be produced by Copilot-VPS. D36. Evidence/design: `docs/copilot-cli-f7-code-gate-rehearsal.md`** |
