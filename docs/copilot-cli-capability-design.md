...
| F6.step6C-4+ | ⏸ pending approval | operator abre PR + reviewer merge --ff-only + `git pull --ff-only` en live worktree + 1 restart + probes; gates de policy/execute/code/egress siguen false |
