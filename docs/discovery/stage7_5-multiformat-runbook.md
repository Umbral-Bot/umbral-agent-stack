...
> **Estado: HISTÓRICO.** Experimento de un enfoque multi-formato para el copywriter de Rick
> (writer con `FORMATS` + variantes por canal). `main` no adoptó este enfoque — el sistema
> vigente es un archivo por canal (`prompts/rick/blog-copy-system.md`,
> `linkedin-copy-system.md`, `x-copy-system.md`), no la variante multi-formato descrita aquí.
> Este documento y el report de evidencia asociado
> ([stage7_5_multiformat_real_v1.json](../../reports/stage7_5_multiformat_real_v1.json)) quedan
> como registro del experimento — **no describen el pipeline de producción actual**. El código
> del experimento (writer/evaluator/tests) permanece solo en `rick/stage7_5-multiformat`, no se
> mergeó (PKG-UAS-P1-2-KEEP3-ARCHIVE-RUNBOOK, 2026-08-06).
>
