...
|---|---|---|---|
| **W** | Copilot-VPS | ⏸ opcional | `autorizo cleanup worktree D3.2` |
| **AA** | Copilot-VPS | 🔴 **Siguiente** | D3.3 preflight (task 020) |
| **AB** | Copilot-VPS | ⏸ | `D33_PREFLIGHT_OK` + `autorizo torneo D3.3` |
