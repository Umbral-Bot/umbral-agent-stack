...
| P1.2 | ~~30 huérfanas + 26 worktrees Codex + 2 clones + KILL mergeadas~~ → MERGED_KILL **DONE** (192/192, #589) + worktrees Codex **DONE** (43→9) + huérfanas-con-merge-base **KILL DONE** (28/28, #591) + **RESCUE1 DONE** (2 docs, #592, mergeado + rama fuente ya borrada). Los 3 KEEP: **brief DONE, ejecución PENDING** ([uas-p1-2-orphan-keep3-2026-08-06.md](uas-p1-2-orphan-keep3-2026-08-06.md)) — recomendaciones: `codex/docs-pit-v2-contract`→ARCHIVE_DOCS_ONLY (solo 3 docs, excluir SKILL.md runtime), `rescue/coordinador-dirty-2026-07-13`→RESCUE_SELECTIVE (solo el `.ps1`), `rick/stage7_5-multiformat`→KEEP_INDEFINITE (fork de producto). Faltan las 58 sin merge-base (cherry-pick puntual, no lote) | Claude local (con GO) |
