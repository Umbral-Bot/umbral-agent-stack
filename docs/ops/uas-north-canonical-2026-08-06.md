...
| P1.2 | ~~30 huérfanas + 26 worktrees Codex + 2 clones + KILL mergeadas~~ → MERGED_KILL **DONE** (192/192, #589) + worktrees Codex **DONE** (43→9) + huérfanas-con-merge-base **KILL DONE** (28/28, #591) + **RESCUE1 DONE** (2 docs, #592) + **fila 1 (PIT) ARCHIVE_DOCS_ONLY DONE** (#594) + **fila 2 RESCUE_SELECTIVE DONE** (`scripts/export-vscode-config.ps1` traído a `main`, [uas-p1-2-keep2-rescue-ps1-2026-08-06.md](uas-p1-2-keep2-rescue-ps1-2026-08-06.md); revisado sin secretos/PII; `human-review-contract.md` de esa misma rama queda fuera, diff 0). **PENDING**: fila 3 (`rick/stage7_5-multiformat`, KEEP_INDEFINITE, sin acción prevista) y las 58 sin merge-base (cherry-pick puntual, no lote) | Claude local (con GO) |
