...
| P1.2 | ~~30 huérfanas + 26 worktrees Codex + 2 clones + KILL mergeadas~~ → MERGED_KILL **DONE** (192/192, #589) + worktrees Codex **DONE** (43→9) + huérfanas-con-merge-base **KILL DONE** (28/28, #591) + **RESCUE1 DONE** (2 docs, #592, mergeado + rama fuente ya borrada) + **fila 1 (PIT) ARCHIVE_DOCS_ONLY DONE** (3 docs marcados HISTÓRICO, [uas-p1-2-keep1-archive-2026-08-06.md](uas-p1-2-keep1-archive-2026-08-06.md); SKILL.md/vision-doc runtime intactos, confirmado diff 0). **PENDING**: fila 2 (`.ps1` de `rescue/coordinador-dirty-2026-07-13`) y fila 3 (`rick/stage7_5-multiformat`, KEEP_INDEFINITE, sin acción prevista); las 58 sin merge-base (cherry-pick puntual, no lote) | Claude local (con GO) |
