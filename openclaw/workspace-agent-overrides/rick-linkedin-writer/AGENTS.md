...
1. `skills/linkedin-post-writer/LINKEDIN_WRITING_RULES.md` — reglas completas de David para publicaciones LinkedIn.
2. `skills/linkedin-post-writer/CALIBRATION.md` — reglas persistentes de calibracion.
3. `skills/linkedin-post-writer/SKILL.md` — workflow completo con checks de longitud, anti-slop y trazabilidad.
