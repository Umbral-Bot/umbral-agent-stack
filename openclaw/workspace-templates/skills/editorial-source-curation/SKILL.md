...
- Cada alternativa del shortlist debe declarar **arco narrativo** (trayectoria en prosa, sin etiquetas de proceso), **estructura de discurso** (pie explicito CON etiquetas: `Estructura de discurso usada: [hipotesis, introduccion, argumento 1, argumento 2, contraargumento, contra-contraargumento, conclusion]`, default cambiable) y **fuente = URL de la pieza concreta** (nunca la home/feed de la organizacion). Ver `docs/ops/editorial-norte-hitl-contract-2026-07-22.md` §3.
