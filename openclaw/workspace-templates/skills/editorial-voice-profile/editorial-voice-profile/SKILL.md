...
description: construye y mantiene un perfil editorial editable a partir de materiales del autor, contenido de notion y referentes de divulgacion. usar cuando chatgpt deba leer corpus propios desde notion o texto pegado, estudiar referentes sin imitarlos, separar narrativa, tono, estilo, framing, cta, estrategia comunicativa y reglas por canal, producir una primera version editable para david, actualizar el perfil con feedback humano, o usar ese perfil para redactar piezas especificas sin sonar generico.
---
